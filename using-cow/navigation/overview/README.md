...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Welcome Card          | Provides a starting point for new users to begin importing devices using either their PSA or a manual CSV import. If this is your first time logging in, you'll want to start here by configuring your PSA connection or performing a CSV import. You can jump over to the [integrations](../integrations/ "mention") page for more information. |
| Messages              | If you have any alerts to review you will see them here. Clicking `View all` will bring up the [messages.md](messages.md "mention") page showing a table of all messages your organization has received with additional details.                                                                                                                 |
